...
export const en = {
  ...
  mailScanSettings: {
    ...
    sourcesHint: "Folders are opened read-only. The resolved path is shown so you can see where a shortcut actually points.",
    ...
    sourceRedirected: "This path points somewhere else — check it before scanning.",
    ...
    thunderbirdFound: (n: number) => `Found ${n} Thunderbird profile folder${n === 1 ? "" : "s"}`,
    thunderbirdNone: "No Thunderbird profile found — add the folder manually.",
